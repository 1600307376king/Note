...
(function(mod) {
  ...
  function onFocus(cm) {
    ...
    if (!cm.state.focused) {
      ...
      // This tests prevents this from firing when a context
  ...
  // start or around the replaced tests. Hint may be "start" or "around".
  ...
  // Lightweight common_form of highlight -- proceed over this line and
