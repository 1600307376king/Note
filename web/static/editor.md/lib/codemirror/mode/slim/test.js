...
(function() {
  ...
  MT("idShortcut",
     "[attribute&def #tests] Hey There");

  MT("tagWithIdShortcuts",
     "[tag h1][attribute&def #tests] Hey There");

  MT("classShortcut",
     "[attribute&qualifier .hello] Hey There");

  MT("tagWithIdAndClassShortcuts",
     "[tag h1][attribute&def #tests][attribute&qualifier .hello] Hey There");
  ...
  MT("attributes",
     "[tag a]([attribute title]=[string \"tests\"]) [attribute href]=[string \"link\"]}");

  MT("multiLineAttributes",
     "[tag a]([attribute title]=[string \"tests\"]",
  ...
  MT("selectorRubyBlock",
     "[tag a][attribute&qualifier .tests][operator&special =] [variable-2 @item]");

  MT("nestedRubyBlock",
      "[tag a]",
      "  [operator&special =][variable puts] [string \"tests\"]");
  ...
  MT("interpolationInHashAttribute",
     "[tag div]{[attribute id] = [string \"]#{[variable tests]}[string _]#{[variable ting]}[string \"]} tests");

  MT("interpolationInHTMLAttribute",
     "[tag div]([attribute title]=[string \"]#{[variable tests]}[string _]#{[variable ting]()}[string \"]) Test");
})();
